...
class CraftingCubeModel implements IModel
{
	...
	private final static ResourceLocation STORAGE_1024K_LIGHT = texture( "storage_1024k_light" );
	private final static ResourceLocation STORAGE_4096K_LIGHT = texture( "storage_4096k_light" );
	private final static ResourceLocation STORAGE_16384K_LIGHT = texture( "storage_16384k_light" );
	...
	{
		return ImmutableList.of( RING_CORNER, RING_SIDE_HOR, RING_SIDE_VER, UNIT_BASE, LIGHT_BASE, ACCELERATOR_LIGHT, STORAGE_1K_LIGHT, STORAGE_4K_LIGHT, STORAGE_16K_LIGHT, STORAGE_64K_LIGHT, STORAGE_256K_LIGHT, STORAGE_1024K_LIGHT, STORAGE_4096K_LIGHT, STORAGE_16384K_LIGHT, STORAGE_CREATIVE_LIGHT, MONITOR_BASE, MONITOR_LIGHT_DARK, MONITOR_LIGHT_MEDIUM, MONITOR_LIGHT_BRIGHT );
	}
